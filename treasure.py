...
# Streamlit App Title
st.title("YouTube Viral Topics Tool (History Niche - Videos Longer Than 8 Minutes)")

# Input Fields
days = st.number_input("Enter Days to Search (1-30):", min_value=1, max_value=30, value=5)

# ✅ History Keywords (Correct Format)
keywords = [
"History Facts Today", "Ancient History Secrets", "World War II Stories",
"World History Facts", "History Untold Truth", "Ancient Civilizations Explained",
...
"World History Timeline Explained", "History of Civilizations", "History Amazing Facts",
"History True Stories", "Hidden History Facts", "History That Will Surprise You",
"Great Historical Leaders", "Unknown Stories of Empires", "Ancient Inventions Explained",
"History of Lost Civilizations", "Shocking History Facts", "Great Wars Explained",
"History Myths and Reality", "True Stories From The Past", "History That Nobody Told You",
"Ancient Kingdom Secrets", "Historical Events That Changed Everything", "History Behind Famous Battles",
"Greatest Kings and Queens in History", "World History in Simple Words", "Untold Ancient Secrets",
"Top Historical Events Explained", "Famous Leaders and Their Stories", "History That Will Blow Your Mind"
]
