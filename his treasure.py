...
# ✅ Streamlit App Title
st.title("YouTube Viral Topics Tool (History Treasure - Videos Longer Than 8 Minutes)")

# ✅ Input Fields
days = st.number_input("Enter Days to Search (1-30):", min_value=1, max_value=30, value=5)

# ✅ History Keywords (SEO Optimized)
keywords = [
    ...
    try:
        ...
        for keyword in keywords:
            ...
            for video, stat, channel in zip(videos, stats, channels):
                ...
                # ✅ Only include videos longer than 8 minutes (480 sec)
                if duration_seconds >= 480:
                    ...
                    # ✅ Fix Subscriber Issue (Show Hidden)
                    subs = channel["statistics"].get("subscriberCount", "Hidden")

                    # ✅ Apply filter only if subs are visible and < 3000
